    ...
    function productView(id){
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $('#pimage').attr('src','/storage/'+data.product.image );
        ...
        $.ajax({
            ...
            <li>
                <div class="shopping-cart-img">
                    <a href="shop-product-right.html"><img alt="Nest" src="storage/${value.options.image} " style="width:50px;height:50px;" /></a>
                </div>
            ...
            success:function(response){
                ...
                $.each(response.wishlist, function(key,value){
                    ...
                    rows += `<tr class="pt-30">
                        ...
                        <td class="image product-thumbnail pt-40"><img src="storage/${value.product.image}" alt="#" /></td>
                        <td class="product-des product-name">
                            <h6><a class="product-name mb-10" href="/product/details/${value.product.id}/${value.product.slug}">${value.product.product_name} </a></h6>
...
<script type="text/javascript">
    ...
    <td class="row_img"><img src="storage/${value.product.image} " style="width:300px; height:300px;"  alt="compare-img" /></td>
                        ...
                        :`<h4 class="price text-brand">$${value.product.discount_price}</h4>`
                                ...
                                <tr class="description">
                                    ...
                                    <td class="row_text font-xs">
                                        <p class="font-sm text-muted"> ${value.product.product_detail}</p>
                                    </td>
...
<script type="text/javascript">
    function cart() {
        $.ajax({
            ...
            <td class="image product-thumbnail pt-40"><img src="storage/${value.options.image} " alt="#"></td>
            <td class="product-des product-name">
