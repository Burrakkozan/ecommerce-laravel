    ...
    <tr>
        ...
        <td align="right">
            <pre class="font" >
               ...
               Email:sptburakozcan@gmail.com <br>
               Mob: 1245454545 <br>
               Turkey Istanbul <br>
    ...
    <tr>
        <td>
          <p class="font" style="margin-left: 20px;">
           <strong>Name:</strong> {{ $order->name }} <br>
              <strong>user Name:</strong> {{ $order->username }} <br>
           ...
           <strong>Phone:</strong> {{ $order->phone }} <br>
            ...
            @endphp
           <strong>Address:</strong> {{ $order->address }} / {{$div}} / {{ $dis }}/ {{ $zipcode }}<br>
        ...
        <td>
          <p class="font">
            ...
            Delivery Date: {{ $order->confirmed_date}} <br>
     ...
     @foreach($orderItem as $item)
      <tr class="font">
        <td style="text-align: center">
            <img src="{{ asset('storage/'.$item->product->image) }}" height="50px;" width="50px;" alt="">
        </td>
